...
const CozumEkle = () => {
  ...
  const { data, mutate, error, isLoading } = useSWR(
    `/api/cozum?username=${session?.data?.user.name}`,
    fetcher
  );
